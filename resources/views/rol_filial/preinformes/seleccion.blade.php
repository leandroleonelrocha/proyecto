			...
			<div class="box">
				<div class="box-header">
					...
					<div class="box-tools pull-right no-print">
						<a href="{{route('filial.preinformes_nuevaPersona')}}" class="btn btn-success text-white"> Agregar nueva Persona</a>
					</div>
				</div>
				<div class="box-body">
					<div class="col-xs-12">
							...
							<tbody>
								@foreach($personas as $persona)
										<tr>
											...
											<td class="text-center"><a href="{{route('filial.preinformes_nuevo',$persona->id)}}" class="btn btn-success text-white">Seleccionar</a></td>
										</tr>
								@endforeach
							</tbody>
						</table>	

					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="col-md-6 form-group">
								...
								<div class="col-xs-3">
									{!! Form::checkbox('genero', 'M') !!} Masculino
								</div>
								<div class="col-xs-3">
									{!! Form::checkbox('genero', 'F') !!} Femenino
								</div>
							</div>
							<div class="col-md-6 form-group">
							...
							<div class="col-xs-12">
			              	...
			              	<div class="col-md-6 form-group">
								...
								{!! Form::select('carrera_id',$tipos->toArray(),null,array('class' => 'form-control', 'multiple')) !!}
							</div>
							<div class="col-md-6 form-group">
								<label>Cursos</label>
								{!! Form::select('curso_id',$tipos->toArray(),null,array('class' => 'form-control', 'multiple')) !!}
							</div>
							<div class="col-md-12 form-group">
								<label>Descrici&oacute;n</label>
								{!! Form::textarea('descripcion_interes',null,array('class'=>'form-control','size'=>'30x4')) !!}
							</div>
